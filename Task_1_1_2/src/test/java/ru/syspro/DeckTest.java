...
class DeckTest {
    ...
    void testDeckContains52Cards() {
        assertEquals(52, deck.size(),
                "Новая колода должна содержать 52 карты");
    }
    ...
    void testShuffleChangesOrder() {
        ...
        deck.shuffle();
        assertNotEquals(originalDeck, deck.getCardsCopy(),
                "Порядок карт после перемешивания должен отличаться");
    }
    ...
    void testDrawFirstCard() {
        ...
        assertEquals(expectedTopCard, actualTopCard,
                "Первая карта должна совпадать с той, что была на вершине колоды");
    }
    ...
    void testEmptyDeckThrowsException() {
        ...
        assertThrows(IllegalStateException.class, () -> deck.drawCard(),
                "Опустошённая колода должна выбросить исключение");
    }
